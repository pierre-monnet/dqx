...
def test_build_rules():
    actual_rules = DQEngineCore.build_checks(
        ...
        DQRule(criticality="warn", check_func=value_is_in_list, col_name="h", check_func_args=[[1, 2]]),
    ]
    ...
    expected_rules = [
        ...
        DQRule(
            name="col_f_value_is_not_in_the_list",
            criticality="warn",
            check_func=value_is_in_list,
            col_name="f",
            check_func_kwargs={"allowed": [3]},
        ...
        DQRule(
            name="col_h_value_is_not_in_the_list",
            criticality="warn",
            check_func=value_is_in_list,
            col_name="h",
            check_func_args=[[1, 2]],
