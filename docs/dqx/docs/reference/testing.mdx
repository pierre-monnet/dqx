...
def test_dq(ws, spark): # use ws and spark pytester fixtures to initialize workspace client and spark session
    ...
    expected_schema = schema + ", _errors: ARRAY<STRUCT<name: STRING NOT NULL, rule: STRING, col_name: STRING NOT NULL, filter: STRING, message: STRING NOT NULL, run_time: STRING NOT NULL>>, _warnings: ARRAY<STRUCT<name: STRING NOT NULL, rule: STRING, col_name: STRING NOT NULL, filter: STRING, message: STRING NOT NULL, run_time: STRING NOT NULL>>"
