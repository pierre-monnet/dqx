...
class DQRule:
    ...
    * `check_func_kwargs` (optional) - keyword /named arguments for the check function after the col_name
    ...
    def check(self) -> Column:
        ...
        return self.check_func(self.col_name, *self.check_func_args, **self.check_func_kwargs)
    ...
    def check_column(self) -> Column:
        ...
        check = self.check()
        return F.when(check.isNotNull(), F.when(filter_col, check)).otherwise(F.lit(None).cast("string"))
